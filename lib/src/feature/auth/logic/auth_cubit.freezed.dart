...
abstract class _Success implements AuthState {
  const factory _Success({required final Profiles user}) = _$SuccessImpl;
...
class __$$NotConnectedImplCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res, _$NotConnectedImpl>
...
class _$NotConnectedImpl with DiagnosticableTreeMixin implements _NotConnected {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'AuthState.notConnected'));
  }
...
abstract class _NotConnected implements AuthState {
