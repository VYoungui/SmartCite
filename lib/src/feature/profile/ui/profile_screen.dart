...
class ProfileArea extends StatelessWidget {
  ...
  builder: (context, state) {
    return state.maybeWhen(
        loading: () => Skeletonizer(child: Column(
          ...
          children: [
            ...
            InputTextField(
                align: TextAlign.start,
                controller: TextEditingController(text: 'akwamou@gmail.com'),
                enabled: true,
                onChanged: (p0) {},
                validator: (p0) {
                  return '';
            ...
            ValidatedButton(
                title: 'Modifier',
                onPressed: () {
                  var snackBar = const AppSnackbar(message: 'Fonctionnalité pas encore disponible').build(context);
                  ScaffoldMessenger.of(context).showSnackBar(snackBar);
                },
