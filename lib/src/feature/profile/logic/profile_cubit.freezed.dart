...
mixin _$ProfileState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Profiles user) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Profiles user)? success,
...
abstract class _$$SuccesImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Profiles user});
}

/// @nodoc
class __$$SuccesImplCopyWithImpl<$Res>
    extends _$ProfileStateCopyWithImpl<$Res, _$SuccesImpl>
...
class _$SuccesImpl implements _Succes {
  const _$SuccesImpl({required this.user});
...
abstract class _Succes implements ProfileState {
  const factory _Succes({required final Profiles user}) = _$SuccesImpl;
